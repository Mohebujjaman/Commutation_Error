...
%load Re_500_Gsnap_SV103K_r2_d7_N30_219.mat
%  
% d=16;
% r=15;
% val=[];
...
% dfilter_CE_error = sqrt(dfilter_error/endTimestep)
%     
%sqrt(sum(sum(pfilter_CE.^2))/endTimestep)
%sqrt(sum(sum(Gsnap.^2))/endTimestep)
clear RHS;
% delta
% val=[val;dfilter_CE_error];
% end
% 
% val
% mydel
